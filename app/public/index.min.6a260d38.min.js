...
$(document).ready(function(){const t=$(window).height(),n=$("#backtotop"),o=t-n.height()-200;function i(){n.css({top:o,right:0})}function e(){$(document.body).height()<t?$("#footer").addClass("fix-bottom"):$("#footer").removeClass("fix-bottom")}n.click(function(){return $("html,body").animate({scrollTop:0}),!1}),$(window).scroll(function(){$(window).scrollTop()>200?n.fadeIn():n.fadeOut()}),i(),e(),$(window).resize(i),$(window).resize(e),$(".topic_content a,.reply_content a").attr("target","_blank"),prettyPrint(),$(".submit_btn").click(function(){$(this).button("loading")}),$(".sponsor_outlink").click(function(){const t=$(this).data("label");ga("send","event","banner","click",t,1,{nonInteraction:1})})});
$(document).ready(function(){var e=$("#responsive-sidebar-trigger"),t=$("#sidebar-mask"),o=$("#sidebar"),n=$("#main"),c=$(window).width(),i=0,a=0,d={x:0,y:0},h=c/3,s=function(e){const t=e.changedTouches;d.x=+t[0].pageX-i,d.y=+t[0].pageY-a,Math.abs(d.x)>Math.abs(d.y)&&e.preventDefault()},u=function(t){let o=t.changedTouches,n=e.data("is-show");d.x=+o[0].pageX-i,!n&&i>3*c/4&&Math.abs(d.x)>h&&e.trigger("click"),n&&i<1*c/4&&Math.abs(d.x)>h&&e.trigger("click"),i=a=0,d.x=d.y=0,document.body.removeEventListener("touchmove",s,!1),document.body.removeEventListener("touchend",u,!1)};("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch)&&document.body.addEventListener("touchstart",function(e){const t=e.targetTouches;i=+t[0].pageX,a=+t[0].pageY,d.x=d.y=0,document.body.addEventListener("touchmove",s,!1),document.body.addEventListener("touchend",u,!1)}),e.on("click",function(){let c=e.data("is-show"),i=n.height(),a=o.outerHeight();o.css({right:c?-300:0}),e.data("is-show",!c),!c&&i<a&&n.height(a),t[c?"fadeOut":"fadeIn"]().height($("body").height()),o[c?"hide":"show"]()}),t.on("click",function(){e.trigger("click")})});
